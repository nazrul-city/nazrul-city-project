...
3. **Multiple types per page are fine** - Google expects several items on one page; nest them or link separate blocks with `@id`. Don't emit the _same_ entity twice with conflicting values
